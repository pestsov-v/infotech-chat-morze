...
export const AUTHORIZATION_MESSAGE = "Do you have an account on not?";
export const INCORRECT_LOGIN_MESSAGE = "Enter correct data or register";

export const INCORRECT_SIGNUP_MESSAGE =
  "Try again or login if you already have an account";
