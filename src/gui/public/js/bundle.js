...
exports.sendMessage = exports.decodeMessage = void 0;
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    (0, _auth.login)(username, password);
  });
}
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    var username = document.getElementById("username").value;
    var password = document.getElementById("password").value;
    (0, _auth.signup)(firstName, lastName, username, password);
  });
}
...
if (messageForm) {
  messageForm.addEventListener("submit", function (e) {
    ...
    (0, _message.sendMessage)(recipient, content);
  });
}
},{"./auth":"auth.js","./message":"message.js"}],"../../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
